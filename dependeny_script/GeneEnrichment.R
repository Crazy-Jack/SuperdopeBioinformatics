...
# gene.name.file <- strsplit(args[1], "/")[[1]][length(strsplit(args[1], "/")[[1]])]
gene.name.file <- args[1]
output.dir = args[2]
print(output.dir)
results_name = strsplit(gene.name.file, "/")[[1]][length(strsplit(gene.name.file, "/")[[1]])]
print(gene.name.file)
GOresults.file <- paste(output.dir, "/",  paste(results_name, "GOresults.txt", sep="."), sep="")
print(GOresults.file)
GOresults.dotpot.file <- paste(GOresults.file, "img-dotplot.jpg",sep=".")
...
Keggresults.file <- paste(output.dir, "/", paste(results_name, "KEGGresults.txt", sep="."), sep="")
print(Keggresults.file)
ReactomeResults.file <- paste(output.dir, "/", paste(results_name, "ReactomeResults.txt", sep="."), sep="")
print(ReactomeResults.file)
